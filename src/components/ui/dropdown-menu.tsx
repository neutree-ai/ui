...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex min-h-8 cursor-default select-none items-center gap-2 rounded-[4px] px-2 py-1.5 text-sm text-[var(--nt-text-neutral-primary)] outline-none transition-colors hover:bg-[var(--nt-fill-neutral-trans-3)] hover:text-[var(--nt-text-neutral-super)] focus:bg-[var(--nt-fill-neutral-trans-3)] focus:text-[var(--nt-text-neutral-super)] data-[highlighted]:bg-[var(--nt-fill-neutral-trans-3)] data-[highlighted]:text-[var(--nt-text-neutral-super)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0 [&[data-variant=destructive]]:text-[var(--nt-fill-serious-base)] [&[data-variant=destructive]]:hover:bg-[rgba(240,72,62,0.1)] [&[data-variant=destructive]]:focus:bg-[rgba(240,72,62,0.1)] [&[data-variant=destructive]]:focus:text-[var(--nt-fill-serious-base)] [&[data-variant=destructive]][data-highlighted]:bg-[rgba(240,72,62,0.1)] [&[data-variant=destructive]][data-highlighted]:text-[var(--nt-fill-serious-base)]",
      inset && "pl-8",
      className,
    )}
    {...props}

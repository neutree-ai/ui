...
import ExternalEndpointMonitorPanel from "@/domains/external-endpoint/components/ExternalEndpointMonitorPanel";
              ...
              <div className="grid grid-cols-4 gap-8">
                ...
                {record.status?.service_url && (
                  <div className="col-span-3">
                    <ShowPage.Row
                      title={t("external_endpoints.fields.serviceUrl")}
                    >
                          ...
                          <thead>
                            <tr className="border-b bg-muted/50">
                              <th className="w-1/2 px-4 py-2 text-left font-medium">
                                {t(
                                  "external_endpoints.fields.exposedModelName",
                                )}
                              </th>
                              <th className="w-1/2 px-4 py-2 text-left font-medium">
                                {t(

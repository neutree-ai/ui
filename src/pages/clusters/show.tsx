                    ...
                    {vgpuProductRows.length > 0 && (
                      <div className="rounded-md border">
                        <div className="grid grid-cols-6 gap-4 border-b px-3 py-2 text-sm font-medium">
                          ...
                          <span>{t("clusters.fields.singleCardMemory")}</span>
                          <span>{t("clusters.fields.vgpuMemoryPool")}</span>
                          <span>{t("clusters.fields.vgpuCorePool")}</span>
                        </div>
                        {vgpuProductRows.map((row) => (
                          <div

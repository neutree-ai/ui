...
export const authStyles = {
  ...
  input:
    "flex h-10 w-full rounded-[var(--nt-radius-input)] border border-[var(--nt-stroke-neutral-trans-3)] bg-[var(--nt-fill-neutral-white)] px-3 py-2 text-sm placeholder:text-[var(--nt-text-neutral-quaternary)] hover:border-[var(--nt-stroke-neutral-trans-4)] focus-visible:border-[var(--nt-stroke-outstanding-base)] focus-visible:outline-none focus-visible:[box-shadow:var(--nt-outline-active-focus)] disabled:cursor-not-allowed disabled:opacity-50",
